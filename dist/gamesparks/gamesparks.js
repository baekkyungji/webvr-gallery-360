...
(function (root, factory) {
	...
	GameSparks.prototype = {
		...
		init: function(options) {
			...
			this.socketUrl = 'wss://live-n352952u7bjx.ws.gamesparks.net/ws/debug-web/N352952u7bjx?GS_CAPA=debug';
		...
		connect: function() {
			...
			try {
				this.webSocket = new WebSocket('wss://live-n352952u7bjx.ws.gamesparks.net/ws/debug-web/N352952u7bjx?GS_CAPA=debug');
				console.log('WEW'+this.webSocket);
